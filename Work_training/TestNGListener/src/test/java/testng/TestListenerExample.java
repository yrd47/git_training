...
public class TestListenerExample {
    ...
    @Test(testName = "yy-123")
    public void t4(){
        Exception e1 = new RuntimeException("Some message");
        Exception e2 = new RuntimeException("Some message",e1);
        throw new RuntimeException("Some other message",e2);
    }
